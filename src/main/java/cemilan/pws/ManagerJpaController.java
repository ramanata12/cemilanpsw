...
import cemilan.pws.exceptions.IllegalOrphanException;
import cemilan.pws.exceptions.NonexistentEntityException;
import cemilan.pws.exceptions.PreexistingEntityException;
...
public class ManagerJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("cemilan_pws_jar_0.0.1-SNAPSHOTPU");

    public EntityManager getEntityManager() {
        return emf.createEntityManager();
    }

    public ManagerJpaController() {
    }
